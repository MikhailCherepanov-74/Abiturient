...
AddingSpecialisation::AddingSpecialisation(QString title, QWidget* parent)
    : QDialog(parent)
{
   ...
   // info_about_already_added->setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Fixed);
   // grid->addWidget(info_about_already_added, 0, 1);
    ...
    QObject::connect(buttonOk, &QPushButton::clicked, this, &AddingSpecialisation::accept);
    QObject::connect(buttonCancel, &QPushButton::clicked, this, &AddingSpecialisation::reject);
}
AddingSpecialisation::~AddingSpecialisation() {
    if(flag_delete)
        delete outPerson;
}
bool AddingSpecialisation::boolFillAll() {
...
InfAboutSpecialisation* AddingSpecialisation::getPersonInf() {
    return outPerson;
}

void AddingSpecialisation::accept() {
